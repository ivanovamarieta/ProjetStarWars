        ...
        <div class="grid-2">
            <div>
                ...
                <div class="form-text">
                    ...
                    <textarea row="50" cols="50" class="text-area" name="abstract" id="abstract">{{old('abstract')}}</textarea>
                ...
                <div class="form-text">
                    ...
                    <textarea row="50" class="text-area" cols="50" name="content" id="content">{{old('content')}}</textarea>
            ...
            <div>
                ...
                <div class="form-submit">
                        <input type="submit" class="button_select" value="{{trans('app.add')}}">
                </div>
            </div>
        </div>
    </form>
